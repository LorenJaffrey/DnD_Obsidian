...
Geste: true
Material: true
Materialkosten: ein Fokus im Wert von mindestens 1.000 GM, wie eine Kristallkugel, ein Silberspiegel oder ein Brunnen voller Weihwasser
Dauer: 10m
Konzentration: true
Ritual: true
Skalierbar: false
...
## Beschreibung
Du kannst eine bestimmte Kreatur deiner Wahl sehen und hören, wenn sie sich auf der gleichen Existenzebene befindet wie du. Das Ziel muss einen Weisheitsrettungswurf ablegen, der modifiziert wird abhängig davon, wie gut du das Ziel kennst und
ob du über einen Gegenstand als physische Verbindung zu ihr verfügst. Wenn das Ziel weiß, dass du den Zauber wirkst, und es beobachtet werden will, kann es den Rettungswurf absichtlich misslingen lassen.
