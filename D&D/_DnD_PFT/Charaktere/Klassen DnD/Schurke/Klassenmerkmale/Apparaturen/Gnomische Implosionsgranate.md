...
# `=this.file.name`
Du wendest eine `=this.Einsatz` auf und wirfst eine kompakte, kugelförmige Bombe, die beim Aufprall implodiert und massiven Schaden verursacht.
Führe einen [[Mechanische Apparaturen#Tüftlerwurf]] gegen [[Schwierigkeitsgrad|SG]] `=this.SG` aus.

Die [[Gnomische Implosionsgranate]] ist ein Meisterwerk gnomischer Ingenieurskunst, das auf der Technologie kontrollierter Implosionen basiert. 
Diese Apparatur zieht die Energie in sich zusammen und entfaltet beim Aufprall eine massive Kraft, die sich direkt auf ein Ziel konzentriert. 
...
- `dice:6d8` auf der 9. Stufe
- `dice:7d8` auf der 13. Stufe
