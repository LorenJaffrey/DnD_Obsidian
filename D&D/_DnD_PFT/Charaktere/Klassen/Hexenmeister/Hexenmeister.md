...
|   3   | [[_DnD_PFT/Charaktere/Klassen/Hexenmeister/Klassenmerkmale/Schauerliche Anrufungen]]                          | `=this.Bekannte_Zauber.Stufe3`  |          2          | `=this.Zauberplätze.Stufe3.Grad0`  | `=this.Zauberplätze.Stufe3.Grad1`  | `=this.Zauberplätze.Stufe3.Grad2`  | `=this.Zauberplätze.Stufe3.Grad3`  | `=this.Zauberplätze.Stufe3.Grad4`  | `=this.Zauberplätze.Stufe3.Grad5`  |
