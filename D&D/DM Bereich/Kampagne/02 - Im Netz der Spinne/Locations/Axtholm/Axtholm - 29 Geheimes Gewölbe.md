# `=this.file.name`
An der Südwand dieses ansonsten leeren Raums steht eine 80 Pfund schwere Eisentruhe mit geschwungenen Füßen. 
Ihr eingebautes Schloss besitzt eine winzige, runde Vertiefung anstelle des üblichen Schlüssellochs.
Bei genauerer Betrachtung lässt sich das winzige Symbol eines Beils erkennen, das von einem Panzerhandschuh gehalten wird. 
Das Symbol ist identisch mit dem, das auf dem Siegelring des Kastellans eingraviert ist und der in Bereich A14 gefunden werden kann - nur gespiegelt.

Fügt man den Siegelring des Kastellans in die Vertiefung ein, öffnet sich die Truhe und bleibt unverschlossen, bis ihr Deckel fest zugedrückt wird. 
...
Zwischen ihnen sind Reliefs eingelassen:
1. Ein Zwerg mit flammendem Bart, in Raserei – zwei Äxte hoch über dem Kopf.
2. Ein Zwerg der seine beiden Äxte zusammenschlägt und einen Feuerschein erzeugt:
