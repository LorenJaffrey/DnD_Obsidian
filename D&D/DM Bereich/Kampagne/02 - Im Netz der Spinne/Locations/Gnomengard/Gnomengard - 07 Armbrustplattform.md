# `=this.file.name`
In dieser Höhle steht auf einem erhöhten Podest eine bizarre, aus Messing und Stahl zusammengesetzte Konstruktion. Zahnräder schnarren, Federn sind gespannt, und mehrere Armbrustarme sind kreisförmig an einem drehbaren Gestell befestigt.  
Das ganze Gebilde erinnert an eine Mischung aus Turm, Standuhr und Riesenigel.  
Ein paar rote Kristalle blinken unheilvoll, sobald jemand den Raum betritt.  
An der Wand daneben befinden sich Hebel, deren Beschriftungen vor lauter Kratzern und Korrekturen kaum noch lesbar sind.

Ein Gnom hat hier offenbar ein **automatisches Verteidigungsgeschütz** gebaut, doch wie bei vielem in Gnomengard ist seine Zuverlässigkeit fraglich.
...
Wenn weniger als 5 Ziele sichtbar sind, konzentriert er sich auf die übrigen.
